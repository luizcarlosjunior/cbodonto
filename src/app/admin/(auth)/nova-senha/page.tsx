'use client'
// src/app/admin/(auth)/nova-senha/page.tsx
    ...
    <>
      {success ? (
        <div className="bg-stone-900 border border-stone-800 p-8 text-center space-y-4">
          ...
          <h2 className="font-serif text-lg text-white">Senha redefinida!</h2>
          <p className="text-stone-400 text-sm">
            Sua senha foi alterada com sucesso. Você será redirecionado para o login em instantes.
          </p>
          <Link
            href="/admin/login"
            className="inline-flex items-center gap-2 text-stone-400 hover:text-white text-xs transition-colors"
          >
            <ArrowLeft size={12} />
        ...
        <form onSubmit={handleSubmit} className="bg-stone-900 border border-stone-800 p-8 space-y-5">
          <div>
            <h2 className="font-serif text-lg text-white mb-1">Criar nova senha</h2>
            <p className="text-stone-500 text-xs">Escolha uma senha segura para sua conta.</p>
          </div>
  ...
  return (
    <div className="min-h-screen bg-stone-950 flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <Suspense fallback={<div className="bg-stone-900 border border-stone-800 p-8 text-stone-500 text-sm text-center">Carregando...</div>}>
          <NovaSenhaForm />
        </Suspense>
